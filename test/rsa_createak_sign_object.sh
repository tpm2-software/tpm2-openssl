...
openssl pkeyutl -provider tpm2 -provider base -inkey object:ak_rsa.obj -sign -rawin -in testdata -out testdata.sig

# export public key
openssl pkey -provider tpm2 -provider base -in object:ak_rsa.obj -pubout -out testkey.pub
