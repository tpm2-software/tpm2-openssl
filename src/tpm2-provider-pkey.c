...
int
tpm2_load_parent(const OSSL_CORE_HANDLE *core, CRYPTO_RWLOCK *esys_lock, ESYS_CONTEXT *esys_ctx,
...
int
tpm2_build_primary(const OSSL_CORE_HANDLE *core, CRYPTO_RWLOCK *esys_lock, ESYS_CONTEXT *esys_ctx,
